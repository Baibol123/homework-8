...
public class RPG_Game {
    ...
    public static void startGame() {
        Boss boss = new Boss(2000, 50, "Volland de Mort");

        Warrior warrior1 = new Warrior(270, 10, "Ahiles");
        Warrior warrior2 = new Warrior(290, 15, "Heracle");
        Medic doc = new Medic(220, 5, "Gendolf", 15, 5);
        Medic assistant = new Medic(300, 5, "Frodo", 5, 5);
        Magic magic = new Magic(280, 20, "Potter", 7);
        Berserk berserk = new Berserk(260, 15, "Axe");
        Witcher witcher = new Witcher(220, 0, "Geralt");
        Thor thor = new Thor(230, 10, "Thor)");
